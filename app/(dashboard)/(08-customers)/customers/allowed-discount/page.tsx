...
const Page = () => {
  ...
  return (
    <DashboardShell title="خصم مسموح به" subtitle="النظام / العملاء / خصم مسموح به" hideHeaderFilters>
      <section className="space-y-6">
        <div className="relative overflow-hidden rounded-3xl border border-(--dash-border) bg-gradient-to-l from-(--dash-primary) via-(--dash-primary-strong) to-(--dash-primary) p-6 text-white shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
          ...
          <div className="relative flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div>
                <p className="text-2xl font-semibold">خصم مسموح به (إشعار مدين)</p>
                <p className="mt-1 text-sm text-white/80">تسجيل إشعارات الخصم المدينة للعملاء.</p>
              </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.65fr]">
            <aside className="rounded-2xl border border-(--dash-border) bg-(--dash-panel) p-5 shadow-(--dash-shadow)">
              ...
              <div className="mt-4 space-y-4 text-sm">
                ...
                <div className="rounded-xl border border-(--dash-primary) bg-(--dash-primary-soft) p-4 text-(--dash-primary)">
              ...
              <div className="mt-5 rounded-xl border border-(--dash-border) bg-(--dash-panel-soft) p-4 text-xs text-(--dash-muted)">
                ...
                <ul className="mt-2 space-y-1">
                  <li>من ح/ خصم مسموح به (Debit)</li>
                  <li>إلى ح/ العملاء (Credit)</li>
                </ul>
              </div>
            </aside>
            ...
            <div className="rounded-2xl border border-(--dash-border) bg-(--dash-panel) p-6 shadow-(--dash-shadow)">
              <div className="grid gap-4 md:grid-cols-2">
                <label className="text-sm text-(--dash-muted)">
                  <span className="mb-2 block font-semibold text-(--dash-text)">العميل (الجهة المستفيدة) *</span>
                ...
                <label className="text-sm text-(--dash-muted)">
                  <span className="mb-2 block font-semibold text-(--dash-text)">رقم الإشعار المدين</span>
                  <input
                    type="text"
          ...
          <section id="archive" className="space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-(--dash-muted)">عرض كل إشعارات الخصم السابقة والبحث داخلها.</p>
              </div>
