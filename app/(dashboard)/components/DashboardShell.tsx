...
const sidebarItems = [
  ...
  { label: "المخزون", href: "/inventory", badge: "3" },
  {
    ...
    children: [
      ...
      { label: "مصروفات سريعة", href: "/expenses/quick" },
    ],
  },
...
const lucideIconMap: Record<string, ReactNode> = {
  ...
  "/sales/imported": <FileCheck2 className="h-5 w-5" aria-hidden="true" />,
  ...
  "/expenses/new": iconPlus,
  "/expenses/quick": <Receipt className="h-5 w-5" aria-hidden="true" />,
  ...
  "/hr": <Users className="h-5 w-5" aria-hidden="true" />,
  "/agents-employees": <Users className="h-5 w-5" aria-hidden="true" />,
  "/agents-monitor": <BarChart3 className="h-5 w-5" aria-hidden="true" />,
...
const sidebarNavigation: Array<SidebarItem> = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "عمليات البيع من CSV", href: "/sales/imported" },
  ...
  { label: "الطاولات", href: "/tables" },
  {
    ...
    children: [
      ...
      { label: "بنود الراتب", href: "/hr/salary-items" },
      { label: "السلف والقروض", href: "/hr/loans" },
    ],
  },
  { label: "المندوبين والموظفين", href: "/agents-employees" },
  { label: "لوحة متابعة المندوبين", href: "/agents-monitor" },
